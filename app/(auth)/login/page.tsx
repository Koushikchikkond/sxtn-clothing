  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm">
        <h1 className="font-display text-5xl uppercase tracking-widest mb-2">Sign In</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-right">
            <Link href="/forgot-password" className="text-xs text-white/40 hover:text-white/70 transition-colors tracking-wide">
              Forgot password?
            </Link>
          </div>
